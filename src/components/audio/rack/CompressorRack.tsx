...
export const CompressorRack: React.FC<CompressorRackProps> = ({ ac, source }) => {
  ...
  return (
    <div className='m-4 flex h-40 w-11/12 select-none items-center border-2 border-acccent bg-background'>
      <div className='mb-8 flex h-full w-2/6 items-center justify-center break-words border-b-2 border-acccent text-acccent sm:mb-16 sm:h-auto sm:justify-start'>
        <p
          className={`${compressor_font.className} m-2 text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl`}
        >
          COMPRESSOR
        </p>
      </div>
