...
const ReverbPlugin: React.FC = () => {
  ...
  return (
    <div className={`${bebas_Neue.className} h-5/6 w-4/6  flex justify-center items-center`}>
      <div className='grid grid-cols-5 bg-slate-400 select-none shadow-xl rounded-md'>
        <div className='col-span-5 text-8xl mt-4 flex items-center justify-between border-b-2 text-slate-700 border-slate-600'>
          <div className='ml-4'>
            <p>Reverb</p>
          </div>
        ...
        <div className='border-l-2 border-slate-600 col-span-1 row-span-4 flex flex-col items-center justify-evenly'>
          <TurnableKnob
            title='Dry'
            angle={dryAngle}
