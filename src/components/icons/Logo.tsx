    ...
    <g id='Page-1' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>
      <g id='Extra-Large' transform='translate(-41, -67)' fill='#C9C9C9' fill-rule='nonzero'>
        <g id='Untitled-3' transform='translate(41, 67)'>
          <g id='Group' transform='translate(305, 18)'>
          ...
          <text id='REFLECTIONS' font-family='Futura-Bold, Futura' font-size='72' font-weight='bold'>
            <tspan x='0' y='141'>
              REFLECTIONS
            </tspan>
          </text>
          <text id='EARLY' font-family='Futura-Bold, Futura' font-size='72' font-weight='bold'>
            <tspan x='0' y='75'>
              EARLY
            </tspan>
          </text>
